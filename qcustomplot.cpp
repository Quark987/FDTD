...
void QCPColorGradient::loadPreset(GradientPreset preset)
{
  ...
  switch (preset)
  {
    ...
    case gpPolar:
      ...
      case gpPolar2:
        setColorInterpolation(ciRGB);
        setColorStopAt(0, QColor(10, 10, 150));
//        setColorStopAt(0.18, QColor(10, 10, 190));
        setColorStopAt(0.28, QColor(10, 10, 240));
        setColorStopAt(0.5, QColor(255, 255, 255));
        setColorStopAt(0.72, QColor(240, 10, 10));
//        setColorStopAt(0.82, QColor(190, 10, 10));
        setColorStopAt(1, QColor(150, 10, 10));
        break;
    case gpSpectrum:
      setColorInterpolation(ciHSV);
